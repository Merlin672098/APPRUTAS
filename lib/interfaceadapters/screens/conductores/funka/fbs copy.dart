...
class Quevoyahacerwn extends StatefulWidget {
  const Quevoyahacerwn({Key? key}) : super(key: key);

  @override
  State<Quevoyahacerwn> createState() => _QuevoyahacerwnStateState();
}

class _QuevoyahacerwnStateState extends State<Quevoyahacerwn> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: const Text('Con la consulta '),
        ),
        body: Column(
          children: [
  ...
  void _toggleLocationListening() {
    if (_isListeningLocation) {
      _stopListening(); // Detiene la escucha de la ubicación si está activa
    } else {
      _listenLocation(); // Inicia la escucha de la ubicación si no está activa
    }
    setState(() {
      _isListeningLocation =
          !_isListeningLocation; // Cambia el estado de la escucha de la ubicación
    });
  }
